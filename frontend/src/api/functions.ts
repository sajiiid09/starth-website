...
export const authRegister = functions.authRegister as Base44Function<{ success: boolean }>;
...
export const authLogin = functions.authLogin as Base44Function<{ user: { roles?: string[] } }>;
