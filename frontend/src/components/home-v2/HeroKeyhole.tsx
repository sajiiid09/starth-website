    ...
    >
      ...
      */}
      <div 
        ...
        className="absolute z-20 overflow-hidden shadow-2xl top-[58%] left-1/2 -translate-x-1/2 -translate-y-1/2 sm:top-[48%] md:top-[40%]" // Manually positioned to sit in the gap
      >
        <video
          autoPlay
          muted
