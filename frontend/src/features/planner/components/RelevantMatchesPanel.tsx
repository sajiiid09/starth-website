    ...
    >
      ...
      <div className="flex-1 space-y-3 overflow-y-auto p-5">
        {activeItems.map((item) => (
          <article
            key={item.id}
            className="group flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_1px_8px_rgba(15,23,42,0.04)] transition-shadow hover:shadow-[0_4px_20px_rgba(15,23,42,0.08)]"
          >
            ...
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8 shrink-0 rounded-full border border-slate-200 bg-white text-slate-600 hover:text-brand-teal"
