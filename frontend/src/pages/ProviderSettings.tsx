              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  <Avatar className="w-24 h-24">
                    <AvatarImage src={userSettings.profile_picture_url} alt="Profile Picture" />
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="email_bookings">New Leads & Bookings</Label>
                        <p className="text-xs text-gray-500">New leads, bookings, cancellations, and changes</p>
                      </div>
                      <Switch
                        id="email_bookings"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="sms_bookings">Urgent Leads</Label>
                        <p className="text-xs text-gray-500">Last-minute inquiries and cancellations</p>
                      </div>
                      <Switch
                        id="sms_bookings"
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="payments@yourservice.com"
                  />
