    ...
    <div className="min-h-screen bg-brand-light text-brand-dark">
      ...
      <div className="grid min-h-[calc(100vh-80px)] grid-cols-1 lg:grid-cols-2">
        <div className="relative hidden h-full lg:flex">
          ...
          <div className="relative z-10 flex h-full w-full flex-col justify-end p-12 text-brand-light">
            ...
            <p className="mt-4 max-w-md text-base text-brand-light/80">
        ...
        <div className="flex items-center justify-center px-6 py-12 lg:px-12">
          <div className="w-full max-w-md">
            <AnimatePresence mode="wait">
              ...
              {activeView !== "role" && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -16 }}
                  transition={{ duration: 0.4, ease: "easeOut" }}
                  className="space-y-6 rounded-3xl border border-white/40 bg-white/80 p-6 shadow-card"
                >
            ...
            <div className="mt-6 text-center text-xs text-brand-dark/60">
